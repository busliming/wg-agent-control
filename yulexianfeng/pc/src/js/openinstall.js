...
OpenInstall = function (e, n, t) {
  function r(n) {
    ...
    var n = [];for (var t in e) {
      var r = e[t];if ("[object Array]" == Object.prototype.toString.call(r)) for (var i = 0; i < r.length; i++) {
    ...
    var n = new t(),
      ...
      n.open(o, i, !1 !== e.async), n.withCredentials = !0;try {
    ...
    var e = n.createElement("canvas");if (e && "function" == typeof e.getContext) for (var t = ["webgl", "webgl2", "experimental-webgl2", "experimental-webgl"], r = 0; r < t.length; r++) {
      var i = t[r],
    ...
    var o = "ex",
      ...
      try {
        if (v = p[h], y && (v.style.position = "absolute", v.style.top = "-100px"), n.body.appendChild(v), "SELECT" === v.nodeName) v.focus();else if ("INPUT" === v.nodeName || "TEXTAREA" === v.nodeName) {
          b && (v.value = x(O(v.value) + b));var C = v.hasAttribute("readonly");C || v.setAttribute("readonly", ""), v.select(), v.setSelectionRange(0, v.value.length), C || v.removeAttribute("readonly");
        } else {
    ...
    function n() {
      ...
      for (var t, i, o, a, c = e.split("\r\n"), u = 0; u < c.length; u++) {
        if (t = c[u], i = t.split(" "), 0 == t.indexOf("a=candidate:") && (o = i[7]) && "host" == o && (a = i[4])) ;else if (0 == t.indexOf("a=rtcp:") && (o = i[2]) && "IP4" == o && (a = i[3])) ;else if (0 != t.indexOf("c=") || !(o = i[1]) || "IP4" != o || !(a = i[2])) continue;a && !l[a] && /[0-9]{1,3}(\.[0-9]{1,3}){3}/.test(a) && ("0.0.0.0" == a || 0 == a.indexOf("127.") || 0 == a.indexOf("169.254") || 3758096384 == (4026531840 & r(a)) || (l[a] = 1, s.push(a)));
      }s.length && n();
    }var o,
        c,
        u,
      ...
      var t = n.createElement("iframe");t.style.display = "none", t.style.visibility = "hidden", t.src = e, n.body.appendChild(t);
    }, loc: function loc(n) {
      e.location = n;
    }, hrf: function hrf(e) {
      var t = n.createElement("a");t.style.display = "none", t.href = e, n.body.appendChild(t), t.click();
    }, inhrf: function inhrf(e) {
      var t = n.createElement("script");t.setAttribute("type", "text/javascript"), t.innerHTML = '(function(){var a = document.createElement("a");a.style.display = "none";a.href = "' + e.replace(/"/g, '\\"') + '";document.body.appendChild(a);a.click();})()', n.body.appendChild(t);
    ...
    function r() {
      ...
      var r = e.mask || t;if ("function" == typeof r && (r = r() || t), "string" == typeof r) {
        ...
        h = this;"function" == typeof e.onready && p.run(function () {
      e.onready.call(h);
      ...
      var n = { channelCode: e.channelCode || I.parseUrlParams().channelCode, c: e._channelRedirect ? 1 : null, apkFileName: e.apkFileName, preferWakeup: e.preferWakeup, _pkgId: e._pkgId };l(function (r) {
        c({ url: o(I.server + "/web/init/" + e.appKey, n, r), method: "POST", contentType: "text/plain;charset=utf-8", data: t, success: function success(e) {
            g(function () {
              e.sh && (v = u(e.sh)), y = e.fu, b = e.fm, C = e.ft, x = e.su, O = e.sm, R = e.st, A = e.ph ? E(e.ph) : null, T = e.pyp ? E(e.pyp) : null, w = e.pye ? parseInt(E(e.pye) || "0") : 0, k = e.dsoi, L = e.channelCode, N = e.csu, p.ready();
            });
          } });
      });
    }();
  ...
  }, I.parseUrlParams = r, I.docReady = g, I.server = "//openinstall.io", I.wakeupOrInstall = function (e, n, t, r, i) {
    n ? f(e, n, function () {
      S[t](r);
    }, i) : S[t](r);
  }, I;

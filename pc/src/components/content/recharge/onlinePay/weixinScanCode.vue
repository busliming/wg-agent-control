    ...
    <div class="container-fluid">
       <div class="fluid_box">
            ...
            <el-row style="padding-top:60px;">
                ...
                <el-col :span="8" :offset="8"  v-if="maxQuota==''? false:true">
       ...
       <form id="payform" action="http://payment.leyingpaysys.com/payment_platform/form/toForm" :method="potform.post" target="_blank">
